                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item text-center">
                        <a class="nav-link text-white {{ Request::Path() === 'contact' ? : ''}}"
                            href="/contact"><strong>Contact</strong></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-7 p-1">
                <h5 class="p-2 font- fw-bolder" style="background-color:#F2B645;">Contact</h5>
                <div class="pl-2 pt-1">
                    <h5 class="h5_Title"><strong><span><i class="bi bi-geo-alt-fill"></i></span> Store Address
                            :</strong></h5>
                ...
                <div class="pl-2 pt-1">
                    <h5 class="h5_Title"><strong><span><i class="bi bi-clock-fill"></i></span> Open Daily :</strong>
                    </h5>
                    <p>08.00 - 20.00</p>
                </div>
                <div class="pl-2 pt-1">
                    <h5 class="h5_Title"><strong><span><i class="bi bi-telephone-fill"></i></span> Contact :</strong>
                    </h5>
