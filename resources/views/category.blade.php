            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item active text-center">
                        <a class="nav-link text-white {{ Request::Path() === '/' ? : ''}}"
    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-7 p-1">
                <h5 class="p-2 font- fw-bolder" style="background-color:#F2B645;">{{$categoryTitle}}</h4>
                    <div class="gap-2 d-flex justify-content-end">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @if(count($books) == 0)
                                <tr >
                                    <td class="table-warning">No Data..</td>
                                    <td class="table-warning">No Data..</td>
                                </tr>
                                @else
                                @foreach($books as $book)
                                <tr>
                                    <td><a href="/bookdetail/{{$book->id}}" class="text-decoration-none">{{$book->title}}</a></td>
